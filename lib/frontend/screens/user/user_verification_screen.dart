...
class UserVerificationScreen extends StatelessWidget { const UserVerificationScreen(this.state, {super.key}); final UserState state;
  @override Widget build(BuildContext context) { final u = state.user; return Scaffold(body: SafeArea(child: Center(child: SingleChildScrollView(padding: const EdgeInsets.all(24), child: ConstrainedBox(constraints: const BoxConstraints(maxWidth: 430), child: UserCard(child: Column(children: [
